...
async function checkPaymentChannels() {
    try {
        ...
        try {
            const response = await axios_1.default.get('https://api.korapay.com/merchant/api/v1/charges/channels', {
                headers: {
            ...
            if (response.status === 200 && response.data.status) {
                ...
                const mobileMoney = channels.find((channel) => channel.channel_code === 'mobile_money');
                if (mobileMoney) {
...
//# sourceMappingURL=check-payment-channels.js.map