...
async function checkWebhookUrl() {
    try {
        ...
        const webhookUrl = env_1.config.payment.korapay.callbackUrl;
        ...
        if (isNgrok) {
            ...
            if (match && match[1]) {
                ...
                try {
                    ...
                    const response = await axios_1.default.get(`https://${ngrokDomain}/health`, { timeout: 5000 });
...
checkWebhookUrl();
//# sourceMappingURL=check-webhook-url.js.map