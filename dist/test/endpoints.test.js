...
async function testPriceEndpoint() {
    ...
    try {
        ...
        const priceResponse = await axios_1.default.get(`${API_URL}/price`, {
            params: { crypto_type: TEST_CRYPTO }
        });
        logResponse("Price Per Unit", priceResponse.data);
        // Test converting crypto to naira
        const conversionResponse = await axios_1.default.get(`${API_URL}/price`, {
            params: {
...
async function testConvertEndpoint() {
    ...
    try {
        ...
        const response = await axios_1.default.get(`${API_URL}/convert`, {
            params: {
...
async function testBalanceEndpoint() {
    ...
    try {
        ...
        const response = await axios_1.default.get(`${API_URL}/balance`, {
