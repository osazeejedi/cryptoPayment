...
async function testGetBanks() {
    ...
    try {
        const response = await axios_1.default.get(`${API_URL}/payment/banks`);
        console.log('\n=== Available Banks ===');
...
async function testCardPayment() {
    ...
    try {
        ...
        const response = await axios_1.default.post(`${API_URL}/payment/card`, TEST_CARD_PAYMENT);
...
async function testBankTransfer() {
    ...
    try {
        const response = await axios_1.default.post(`${API_URL}/payment/bank-transfer`, TEST_BANK_TRANSFER);
...
async function testVerifyPayment(reference) {
    ...
    try {
        const response = await axios_1.default.get(`${API_URL}/payment/verify/${reference}`);
