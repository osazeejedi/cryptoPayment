...
async function testBankPayout() {
    try {
        ...
        // Get narration
        const narration = await new Promise(resolve => {
        ...
        const payoutResult = await korapayService_1.KorapayService.processBankPayout(amount, accountNumber, selectedBank.code, accountName, narration);
...
testBankPayout();
//# sourceMappingURL=test-bank-payout.js.map